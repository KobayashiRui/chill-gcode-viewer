...
class LineSegments3 extends Mesh {
  ...
  raycast(raycaster, intersects) {
    ...
    if (camera === null && !worldUnits) {
      console.error(
        'LineSegments3: "Raycaster.camera" needs to be set in order to raycast against LineSegments2 while worldUnits is set to false.',
      )
    }
