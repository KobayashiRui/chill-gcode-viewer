...
export default function ThemeToggle(){
    ...
    const setDarkMode = useViewSettingStore((state)=>state.setDarkMode)
    ...
    return (
        <label className="flex cursor-pointer gap-2">
          ...
          <input type="checkbox" checked={darkMode} onChange={handleToggleDarkMode} className="toggle theme-controller" />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
